import { IClient } from '@/features/clients/types/clients'
import { useFetchCouriers } from '@/features/drivers/queries/courierQueries'
import {
  useCreateNewOrder,
  useFetchProductsList,
} from '@/features/orders/queries/orders-queries'
import { CreateNewOrderTransBody } from '@/features/orders/types/orders'
